...
namespace Persistence.Migrations
{
    ...
    [Migration("20210727171858_newmigrationforCourseInstructorFluentValidaton")]
    partial class newmigrationforCourseInstructorFluentValidaton
    {
            ...
            modelBuilder.Entity("Domain.Models.Prices", b =>
                {
                    b.HasOne("Domain.Models.Courses", "Courses")
                        .WithOne("Prices")
                        .HasForeignKey("Domain.Models.Prices", "PriceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
